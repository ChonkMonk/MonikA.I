...
def load_from_json(variable, entry):
    try:
        ...
        entry.delete(0, tk.END) # not sure i need this line but I guess it's there for insurance
...
# loading past info if it exists (code is still messy, can be optimized a lot)
